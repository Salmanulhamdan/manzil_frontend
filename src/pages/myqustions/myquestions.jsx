  ...
  return (
    <div className='center-container pt-16'>
      ...
      <div className='mainclass'>
        ...
        {qustionlist && qustionlist.length > 0 ? (qustionlist.map((qustion, index) => (
        ...
        <p className="text-gray-500 mt-2">You didn't ask any question yet. Ask one now!</p>
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4" onClick={openqustionModal}>
          <FontAwesomeIcon icon={faQuestion} className="mr-2" />
          Ask Question
        </button>
        <QustionModal isOpen={QustionModalOpen} onClose={closequstionModal} />
